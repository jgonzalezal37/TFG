...
class modoMedio:
    ...
    def __init__(self):
        ...
        for i in range(4): 
            for j in range(4): 
                ...
                if i==3 and j==3: 
                    ...
                    self.listaImagenes.append([ImageTk.PhotoImage(Image.open(self.path).resize((600,600)).crop(((j*150),(i*150),((j*150)+150),((i*150)+150)))),self.cmp]) 
                    self.listaImagenesCopia.append([ImageTk.PhotoImage(Image.open(self.path).resize((600,600)).crop(((j*150),(i*150),((j*150)+150),((i*150)+150)))),self.cmp])
                ...
                self.Lab[self.cmp].place(x=3,y=3,width=144,height=144) 
                self.listaFrames[self.cmp].place(x=j*150,y=i*150,width=150,height=150) 
                self.cmp+=1
        ...
        #h es el numero de la pieza que fue clicada.
            global b
            if self.Lab[h].cget("bg")=="#242424" and (h-1==self.index or h+1==self.index or h+4==self.index or h-4==self.index) : 
        ...
        def cticlick(event): 
            ...
            if e is not None:
                ...
                self.easyMode.title((" "*60)+"Modo Medio | The image is loading ...") 
                cmp=0 
                for i in range(4): 
                    for j in range(4): 
                        if i==3 and j==3: 
                                ...
                                self.listaImagenes.append([ImageTk.PhotoImage(Image.open(path).resize((600,600)).crop(((j*150),(i*150),((j*150)+150),((i*150)+150)))),cmp]) 
                                self.listaImagenesCopia.append([ImageTk.PhotoImage(Image.open(path).resize((600,600)).crop(((j*150),(i*150),((j*150)+150),((i*150)+150)))),cmp]) 
                        cmp+=1
            cos(None)
            self.easyMode.title((" "*80)+"Modo Medio") 
            self.easyMode.iconbitmap("Icons/A.ico")
